...
class OfflineCollectionTests(unittest.TestCase):
    ...
    def test_main_only_complete_export_is_limited_not_sampled(self) -> None:
        ...
        self.assertEqual(analysis["pr11_main_only_trigger"]["conflict"], "NO_CONFLICT_IN_REPOSITORY_EXPORT")
        ...
        for mode, expected in [
            ...
            with self.subTest(mode=mode):
                ...
                if mode == "list_403":
                    ...
                    self.assertEqual(analysis["non_main_expected_context"]["conclusion"], "UNKNOWN")
                if mode == "interrupt":
    ...
    def test_credentials_never_enter_packet(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(status["TOOL_IMPLEMENTATION"], "COMPLETE")
